                    ...
                    <div class="w-full p-4">
                        <nav class="space-y-1 {{ $isPlatformAdmin ? 'rounded-lg bg-white p-2 shadow-xs' : '' }}">
                            ...
                            @elseif (auth()->user()->currentOrganization)
                                <x-nav-link :href="route('organizations.people.index', auth()->user()->currentOrganization)" :active="request()->routeIs('organizations.people.*')" wire:navigate>
                                    <span class="flex flex-none items-center text-gray-400">
                                        <svg class="inline-block size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <x-nav-link :href="route('organizations.products', auth()->user()->currentOrganization)" :active="request()->routeIs('organizations.products')" wire:navigate>
                                    <span class="flex flex-none items-center text-gray-400">
                                        <svg class="inline-block size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <x-nav-link :href="route('organizations.transactions', auth()->user()->currentOrganization)" :active="request()->routeIs('organizations.transactions')" wire:navigate>
                                    <span class="flex flex-none items-center text-gray-400">
                                        <svg class="inline-block size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                                ...
                                <x-nav-link :href="route('organizations.events', auth()->user()->currentOrganization)" :active="request()->routeIs('organizations.events')" wire:navigate>
                                    <span class="flex flex-none items-center text-gray-400">
                                        <svg class="inline-block size-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
